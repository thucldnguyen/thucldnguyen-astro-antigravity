...
- One suppressed persistent tooltips that kept getting in the way when police investigators or supervisors tried to edit clips or markers in evidence videos.
...
At Axon, PR review bots and (human) code maintainers are strict. And for good reason. We ship to production environments across the US, UK, Canada, Latin America, Australia, and more. When the stakes are that high, “it works on my machine” means nothing.
...
That skill is increasingly valuable, especially in startups or on teams where engineering capacity is the bottleneck. If you can fix a paper cut yourself, unblock a small issue, or [validate an idea without waiting in line](/blog/orchestrating-ai-teams/), that’s real leverage.
...
PMs should be comfortable coding. But we should not spend our highest-value hours pretending to be full-time engineers. That is not where the leverage is.
...
Those customer calls are where the real product signal comes from: where users hesitate, what they ignore, and what slows them down under pressure. That context is what tells you *which* problems are worth solving now versus later.
...
I recently checked my Claude usage to make sure I was using AI aggressively *and* responsibly.

My April Claude usage month to date was about $696, which is still within Axon's $1,000/mo budget.
