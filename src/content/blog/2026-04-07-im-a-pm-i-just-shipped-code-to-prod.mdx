...
The point of this post: code generation is the easy part now. Judgment, testing rigor, and choosing the right problem are the hard parts.
...
One more practical point on being AI-first as a PM: use the budget with intent.
...
Don’t overspend. But don’t underuse the leverage either. The bar is an AI-first mindset applied everywhere it meaningfully improves speed, quality, or learning.
...
Lenny summarized a recent conversation with Anthropic’s Head of Growth, Amol Avasare, in a way that really clicked for me: engineering is getting the most AI leverage, and it’s squeezing PMs and designers ([post](https://www.linkedin.com/posts/lennyrachitsky_my-biggest-takeaways-from-anthropics-head-activity-7446932397385818112-QFR8)).
