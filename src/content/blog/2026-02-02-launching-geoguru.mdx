...
description: "How I built, polished, and optimized a geography mini-game in one morning using an AI-first workflow. Spoilers: It wasn't just 'generate and done'."
...
## 5. Final touches
After all the grunt work is done, I finally played with it a lot and was able to focus on polishing it. I discovered that no matter how high or low your score is, the level-clear screen always displays "Hurray you're a GeoGuru". I fixed it by asking Antigravity to add a logic to display the correct message based on the score.
...
## 6. The Asset Pipeline Challenge: Mapping the World
